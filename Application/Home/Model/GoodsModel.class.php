...
class GoodsModel extends Model{
    //疯狂抢购
    public function get_is_promote(){
        //获取当前时间
        $date=time();
        return $this->field('goods_id,goods_name,promote_price,logo')->order('sort_num')->where(array('is_promote'=>array('eq',1),
                                    'is_on_sale'=>array('eq',1),
                                    'is_delete'=>array('eq',0),
                                    'promote_start_time'=>array('lt',$date),
