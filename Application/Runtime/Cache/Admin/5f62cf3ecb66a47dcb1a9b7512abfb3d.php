...
.explode {
  background:url(/Application/Admin/Public/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/Application/Admin/Public/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/Application/Admin/Public/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/Application/Admin/Public/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
        <?php foreach($btn as $k1=>$v1):?>
            <li class="explode" key="02_cat_and_goods" name="menu">
            <?php echo $v1['pri_name']?>
                <ul>
                	<?php foreach($v1['child'] as $v2):?>
                    <li class="menu-item">
                    <a href="<?php echo U($v2['module_name'].'/'.$v2['controller_name'].'/'.$v2['action_name'])?>" target="main-frame">
...
<script type="text/javascript" src="/Application/Admin/Public/Js/global.js"></script>
<script type="text/javascript" src="/Application/Admin/Public/Js/utils.js"></script>
<script type="text/javascript" src="/Application/Admin/Public/Js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/Application/Admin/Public/Images/menu_minus.gif' : '/Application/Admin/Public/Images/menu_plus.gif';
