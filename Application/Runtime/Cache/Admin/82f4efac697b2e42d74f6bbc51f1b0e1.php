    ...
    <form name="main_form" method="POST" action="/index.php/Admin/Admin/add.html" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
        	<tr>
                ...
                <td>
                	<?php if(is_array($roles)): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input  type="checkbox" name="role_id[]" value="<?php echo ($vo["role_id"]); ?>" /><?php echo ($vo["role_name"]); ?>&nbsp&nbsp&nbsp<?php endforeach; endif; else: echo "" ;endif; ?>
                </td>
            </tr>
            <tr>
