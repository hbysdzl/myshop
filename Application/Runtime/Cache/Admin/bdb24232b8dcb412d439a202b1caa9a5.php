...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="/Application/Admin/Public/Images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <ul>
        ...
        <div id="send_info">
        	<a style="font-size:15px">您好！<?php echo $admin=session('username')?></a>
            <a href="#" target="main-frame" class="fix-submenu">清除缓存</a>
            <a href="/index.php/Admin/Index/unsetLogin" target="_top" class="fix-submenu">退出</a>
        </div>
    </div>
</div>
<div id="menu-div">
    <ul>
        ...
        <li><a href="/index.php/Admin/Goods/goodslist" target="main-frame">商品列表</a></li>
