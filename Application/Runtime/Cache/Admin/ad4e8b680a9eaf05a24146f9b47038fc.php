...
.main-div table {background: #BBDDE5;}
       ...
       <div class="list-div">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="left"><?php echo ($arr["shr_province"]); ?>,<?php echo ($arr["shr_city"]); ?>,<?php echo ($arr["shr_area"]); ?></td>
                </tr>
                <tr>
     ...
     <form action="/index.php/Admin/Order/delive/orderid/47.html" method="post" name="theForm" enctype="multipart/form-data">
        <div class="list-div">
            <table width="100%" cellpadding="3" cellspacing="1">
                <tr>
