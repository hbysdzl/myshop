	    ...
	    <form name="main_form" method="POST" action="/index.php/Admin/Goods/add.html" enctype="multipart/form-data">
	    	...
	    	<table class="table_content" cellspacing="1" cellpadding="3" width="100%">
	            <tr>
	                ...
	                <td>
	                    <input size="25" type="text" name="goods_name" value="" />
	                ...
	                <td>
	                    <select name="cat_id">
							...
							<?php foreach($cate as $v):?>
                               <option value="<?php echo ($v["cat_id"]); ?>"><?php echo str_repeat('-',$v['level']*4); echo ($v["cat_name"]); ?></option>
							<?php endforeach;?>
			    		</select>
			    		<span class="required">*</span>
	                </td>
	                ...
	                <td>
	                    ...
	                    <select name="ext_cat_id[]">
			    			<option value="">-选择扩展分类-</option>
								<?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cat_id"]); ?>"><?php echo str_repeat('-',$vo['level']*4); echo ($vo["cat_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			    		</select>
	                </td>
	            </tr>
	            <tr>
	            ...
	            <tr>
	                ...
	                <td>
	                    <input size="40" type="text" name="seo_keyword" value="" />
	                </td>
	            </tr>
	            <tr>
	                <td class="label">seo优化_描述：</td>
	                <td>
	                    <input size="40" type="text" name="seo_description" value="" />
	                </td>
	            </tr>
	            <tr>
	    	...
	    	<table class="table_content" style="text-align:center" cellspacing="1" cellpadding="3" width="100%" style="display:none;">
	    		...
	    		会员价格（如果没有填会员价格就按折扣率计算价格，如果填了就按填的价格算，不再打折）
                 ...
                 <?php if(is_array($level)): $i = 0; $__LIST__ = $level;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
	    			<td><?php echo ($v["level_name"]); ?>（<?php echo $v['rate']/10?> 折） ：￥<input type="text" size="10" name="ml[<?php echo ($v["level_id"]); ?>]" /> 元</td>
