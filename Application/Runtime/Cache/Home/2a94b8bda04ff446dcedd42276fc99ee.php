	...
	<div class="guide w1210 bc mt15">
		...
		<div class="guide_content fl">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						<?php if(is_array($goods_promote)): $i = 0; $__LIST__ = $goods_promote;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<dl>
								<dt><a href="<?php echo U('Goods/goods?goods_id='.$vo['goods_id']);?>" target='_blank'><?php ShowImage($vo['logo'])?></a></dt>
								<dd><a href="<?php echo U('Goods/goods?goods_id='.$vo['goods_id']);?>" target='_blank'><?php echo ($vo["goods_name"]); ?></a></dd>
				...
				<div class="hot none">
					<ul>
						<?php if(is_array($goods_hot)): $i = 0; $__LIST__ = $goods_hot;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<dl>
								<dt><a href="<?php echo U('Goods/goods?goods_id='.$vo['goods_id']);?>" target='_blank'><?php ShowImage($vo['logo'])?></a></dt>
								<dd><a href="<?php echo U('Goods/goods?goods_id='.$vo['goods_id']);?>" target='_blank'><?php echo ($vo["goods_name"]); ?></a></dd>
				...
				<div class="recommend none">
					<ul>
						<?php if(is_array($goods_best)): $i = 0; $__LIST__ = $goods_best;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<dl>
								<dt><a href="<?php echo U('Goods/goods?goods_id='.$vo['goods_id']);?>" target='_blank'><?php ShowImage($vo['logo'])?></a></dt>
								<dd><a href="<?php echo U('Goods/goods?goods_id='.$vo['goods_id']);?>" target='_blank'><?php echo ($vo["goods_name"]); ?></a></dd>
								<dd><span>售价：</span><strong><?php echo ($vo["shop_price"]); ?> ￥元</strong></dd>
				...
				<div class="new none">
					<ul>
						<?php if(is_array($goods_new)): $i = 0; $__LIST__ = $goods_new;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<dl>
								<dt><a href="<?php echo U('Goods/goods?goods_id='.$vo['goods_id']);?>" target='_blank'><?php ShowImage($vo['logo'])?></a></dt>
								<dd><a href="<?php echo U('Goods/goods?goods_id='.$vo['goods_id']);?>" target='_blank'><?php echo ($vo["goods_name"]); ?></a></dd>
								<dd><span>售价：</span><strong><?php echo ($vo["shop_price"]); ?> ￥元</strong></dd>
	...
	<div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					<ul>
					<?php if(is_array($goods_cat_list)): $i = 0; $__LIST__ = $goods_cat_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href=""><b>.</b><?php echo ($vo["cat_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
			...
			<div class="goodslist fl">
				...
				<div class="goodslist_wrap">
					<div>
						<ul>
						<?php if(is_array($tuijian_diannao)): $i = 0; $__LIST__ = $tuijian_diannao;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
								<dl>
									<dt><a href="<?php echo U('Goods/goods?goods_id='.$vo['goods_id']);?>"><?php ShowImage($vo['logo'])?></a></dt>
									<dd><a href="<?php echo U('Goods/goods?goods_id='.$vo['goods_id']);?>"><?php echo ($vo["goods_name"]); ?></a></dd>
